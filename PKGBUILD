...
replaces=('nss-nspr')
source=(ftp://ftp.mozilla.org/pub/mozilla.org/security/nss/releases/NSS_3_12_RTM/src/${pkgname}-${pkgver}.tar.gz
	nss-nolocalsql.patch
	nss.pc.in
	nss-config.in)
md5sums=('917f4e05f3982bd7fceaede197f0e1d4'
         '1837781eed35bfb6f826cfb3efcd6409'
         'c547b030c57fe1ed8b77c73bf52b3ded'
         '46bee81908f1e5b26d6a7a2e14c64d9f')

build() {
  cd ${startdir}/src/nss-${pkgver}
